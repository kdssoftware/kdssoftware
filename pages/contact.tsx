    ...
    <div className="grid w-full grid-flow-row gap-4 md:w-1/2 lg:w-full lg:grid-flow-col">
        {
            contacts.map(contact => (
                <a href={contact.link} className="relative grid grid-flow-row grid-rows-1 p-3 transition-all duration-150 ease-in-out bg-red-800 rounded-lg cursor-pointer opacity-90 auto-rows-max hover:scale-105 transform-gpu hover:shadow-md hover:shadow-red-800"  key={contact.link}>
