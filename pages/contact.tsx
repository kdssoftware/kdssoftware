    ...
    <div className="grid w-full grid-flow-row gap-4 md:w-1/2 lg:w-full lg:grid-flow-col">
        {
            contacts.map(contact => (
                <a href={contact.link} className="relative grid grid-flow-row grid-rows-1 p-3 
                transition-all duration-150 ease-in-out rounded-lg cursor-pointer  bg-yellow-600 opacity-90 auto-rows-max
                hover:scale-105 transform-gpu hover:shadow-md hover:shadow-yellow-700 hover:w-full"  key={contact.link}>
