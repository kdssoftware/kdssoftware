    ...
    return (
        <>
            <section className="w-full md:w-9/12 xl:w-8/12">
                ...
                <h1 className={`antialiased uppercase text-6xl lg:text-8xl font-bold font-special ${delayOff?"text-red-500":"text-red-50"} transition-colors duration-1000`}>
                    KDS SOFTWARE
                </h1>
                ...
                <p className='font-thin'>
                    ...
                    Learning <span className='text-lg font-medium text-red-400'>new technologies</span> on the way.
                </p>
            </section>
            <footer className="absolute bottom-0 right-0 p-6 text-lg lg:p-32">
                <p className="mb-1 font-thin">Author</p>
                <p>
                    <span className='text-2xl font-bold text-rded-500 font-special'>
                        <a href="//karel.be">Karel De Smet</a>
                    </span>
                    <span className='font-thin text-red-200'>
                        &nbsp;aka&nbsp;
                    </span>
                    <span className='text-2xl font-bold text-red-500 font-special'>
